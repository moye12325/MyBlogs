...
- **3.1.3 Spring充当组件管理角色（IoC）**
    ...
    - ...... 只需要编写元数据（配置文件）告知Spring 管理哪些类组件和他们的关系即可！ 注意：组件是映射到应用程序中所有可重用组件的Java对象，应该是可复用的功能对象！
    - 组件一定是对象
...
- **3.2.1 普通和复杂容器**
    ...
    **普通容器**
    ...
    > 政府管理我们的一生，生老病死都和政府有关。 程序中的复杂容器 Servlet 容器能够管理 Servlet(init,service,destroy)、Filter、Listener 这样的组件的一生，所以它是一个复杂容器。
...
7. 图解IoC配置流程
    ...
    ![](assets/01.%20SpringFramework实战_image_11.png)
...
2. 组件作用域配置
    ...
    3. 作用域配置
        ...
        <bean id="happyComponent8" scope="singleton" class="com.moye.ioc.HappyComponent">  
...
1. **注解理解**
    ...
    ![](assets/01.%20SpringFramework实战_image_16.png)
...
4. **组件添加标记注解**
    ...
    1. 组件标记注解和区别
        ...
        |![](assets/01.%20SpringFramework实战_image_17.png)||
...
```
    ...
    2. 工作流程
![](assets/01.%20SpringFramework实战_image_18.png)
...
1. 需求分析
    ...
    ![](assets/01.%20SpringFramework实战_image_19.png)
...
5. <context:component-scan标签指定注解范围使用@ComponentScan(basePackages = {"com.moye.components"})替代
